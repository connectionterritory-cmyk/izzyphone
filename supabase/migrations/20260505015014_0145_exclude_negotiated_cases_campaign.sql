-- 0145: Update fn_get_cargo_vuelta_campaign_targets to exclude 'En Negociación' and 'Acuerdo'
-- 
-- Objetivo:
--   Evitar contactar clientes que ya están en proceso de negociación o con acuerdo activo.
--
...
as $$
  with case_base as (
    ...
    where cv.org_id = p_org_id
      -- EXCLUSIÓN SOLICITADA: Solo casos abiertos sin negociación o acuerdo previo
