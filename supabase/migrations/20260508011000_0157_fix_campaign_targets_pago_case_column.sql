-- 0157: Fix fn_get_cargo_vuelta_campaign_targets pago case column
--
-- Contexto:
--   cob_pagos migró a columna operativa cargo_vuelta_case_id.
--   La función de targets aún referenciaba pago.case_id, causando error:
--   "column pago.case_id does not exist".
--
-- Alcance:
--   - Solo corrige referencia de cob_pagos en la función.
--   - No cambia lógica de negocio, cron, ledger, pagos ni otras tablas.
