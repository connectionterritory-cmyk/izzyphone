-- Step 1: fix constraint (drop old _chk and _check names, add correct one)
...
-- Step 2: drop old 7-arg function before replacing with 8-arg version
drop function if exists public.fn_abrir_o_actualizar_cargo_vuelta_case(
  uuid, numeric, date, integer, text, text, text
);

-- Step 3: create updated RPC with p_tipo_caso parameter
