(function () {
  ...
  const ICONS = {
    ...
    ambassadors: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round"><path d="m8 12 3 3"/><path d="m16 8-5 5"/><path d="M2 10h4l3-3a2.83 2.83 0 0 1 4 0l1 1"/><path d="M14 18h4l4-4-4-4h-4"/><path d="m6 14-4 4"/><path d="m18 6 4-4"/></svg>`,
    users: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M6 20a6 6 0 0 1 12 0"/></svg>`,
    ...
    academy: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></svg>`,
  ...
  const SIDEBAR_ITEMS = [
    {
      ...
      items: [
        ...
        { key: 'academy', href: 'academy.html', icon: ICONS.academy, text: 'Izzy Academy' },
